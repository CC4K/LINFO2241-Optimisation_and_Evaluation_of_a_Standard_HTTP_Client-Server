...
void test_patterns(uint32_t *matrix, uint32_t matrix_size, uint32_t *patterns,
    ...
    for (uint32_t i = 0; i < (m - pattern_size + 1); i++) {  // 0 => 64-16 + 1 = 48 + 1 = 49
        for (uint32_t j = 0; j < n; j++) {                   // 0 => 2
            ...
            uint32_t k = 0;
            for (; k + 7 < pattern_size; k += 8) {  // 0 => 16
                dist += (matrix[i + k + 0] - patterns[new_j + k + 0]) *
                        (matrix[i + k + 0] - patterns[new_j + k + 0]);
                dist += (matrix[i + k + 1] - patterns[new_j + k + 1]) *
                        (matrix[i + k + 1] - patterns[new_j + k + 1]);
                dist += (matrix[i + k + 2] - patterns[new_j + k + 2]) *
                        (matrix[i + k + 2] - patterns[new_j + k + 2]);
                dist += (matrix[i + k + 3] - patterns[new_j + k + 3]) *
                        (matrix[i + k + 3] - patterns[new_j + k + 3]);
                dist += (matrix[i + k + 4] - patterns[new_j + k + 4]) *
                        (matrix[i + k + 4] - patterns[new_j + k + 4]);
                dist += (matrix[i + k + 5] - patterns[new_j + k + 5]) *
                        (matrix[i + k + 5] - patterns[new_j + k + 5]);
                dist += (matrix[i + k + 6] - patterns[new_j + k + 6]) *
                        (matrix[i + k + 6] - patterns[new_j + k + 6]);
                dist += (matrix[i + k + 7] - patterns[new_j + k + 7]) *
                        (matrix[i + k + 7] - patterns[new_j + k + 7]);
            }
...
#else // everything that isn't BEST
